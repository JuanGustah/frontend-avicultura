...
export default function DetailEgg() {
    const eggID = new URLSearchParams(useLocation().search).get("eggID");
    ...
    useEffect(() => {
        document.title = "Perfil: Detalhe de Ovo - Avicultura"
    }, []);
    ...
    return (
        <div className="detailEgg-container">
                ...
                <div className="container">
                    <form id="updateForm" onChange={handleFormChanges} onSubmit={handleSubmit} autoComplete="off">
                        <div className="header-row">
                            ...
                            <div>
                                <Link to={`/profile/listeggs?session=${sessionID}&page=1`}>
